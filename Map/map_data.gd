...
const tile_types = {
	...
	"stone": preload("res://assets/definitions/tiles/stone.tres"),
	"debug": preload("res://assets/definitions/tiles/debug.tres"),
	"wall_blue": preload("res://assets/definitions/tiles/wall_blue.tres"),
	"wall_red": preload("res://assets/definitions/tiles/wall_red.tres"),
}
